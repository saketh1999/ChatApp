...
public class ChatActivity extends AppCompatActivity {
    ...
    private DatabaseReference RootRef,mNotificationRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNotificationRef= FirebaseDatabase.getInstance().getReference().child("Message Notifications");
...
setSupportActionBar(ChatToolBar);
        ...
        lineraLayoutManager=new LinearLayoutManager(this);
        userMessagesList.setLayoutManager(lineraLayoutManager);
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if(task.isSuccessful()){
                                        ...
                                        mNotificationRef.child(messageReceiverID).push().setValue(messageNotification).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
